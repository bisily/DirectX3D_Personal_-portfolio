#ifndef Tool_Monster00_h__
#define Tool_Monster00_h__
...
class CTool_Monster00 : public Engine::CGameObject
{
private:
	explicit CTool_Monster00(LPDIRECT3DDEVICE9	pGraphicDev);
public:
	virtual	~CTool_Monster00(void);
...
public:
	static	CTool_Monster00*		Create(LPDIRECT3DDEVICE9 pGraphicDev
											, wstring _tagMeshName
											, int iObjIndex = 0
											, Engine::_vec3 vPosition = Engine::_vec3(0.f, 0.f, 0.f)
											, Engine::_vec3 vScale = Engine::_vec3(0.01f, 0.01f, 0.01f));

	static CTool_Monster00*			CreateLoad(LPDIRECT3DDEVICE9 _pGraphicDev
												, wstring _tagMeshName
												, Engine::_vec3 * _temp_Right
												, Engine::_vec3 * _temp_Up
												, Engine::_vec3 * _temp_Look
