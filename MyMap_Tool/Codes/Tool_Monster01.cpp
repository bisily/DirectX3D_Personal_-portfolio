...
CTool_Monster01::CTool_Monster01(LPDIRECT3DDEVICE9 pGraphicDev)
	: Engine::CGameObject(pGraphicDev)
{

}

CTool_Monster01::~CTool_Monster01(void)
{

}

HRESULT CTool_Monster01::Ready_Object(wstring _tagMeshName
	, int _iObjIndex
...
HRESULT CTool_Monster01::Ready_Load_Object(wstring _tagMeshName
...
Engine::_int CTool_Monster01::Update_Object(const Engine::_float& fTimeDelta)
{
...
void CTool_Monster01::Render_Object(void)
{
...
void CTool_Monster01::SetUp_Animation(Engine::_int iIndex)
{
	m_pMeshCom->Set_AnimationSet(iIndex);
}

HRESULT CTool_Monster01::Add_Component(void)
{
	...
	// For.Mesh
	pComponent = m_pMeshCom = dynamic_cast<Engine::CDynamicMesh*>(Engine::Clone_Resource(RESOURCE_STAGE, L"Mesh_Monster0119"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
void CTool_Monster01::SetUp_OnTerrain(void)
{
...
Engine::_vec3 CTool_Monster01::PickUp_OnTerrain(void)
{
	Engine::CTerrainTex*		pTerrainBufferCom = dynamic_cast<Engine::CTerrainTex*>
...
CTool_Monster01* CTool_Monster01::Create(LPDIRECT3DDEVICE9 pGraphicDev
	, wstring _tagMeshName
	, int _iObjIndex
	, Engine::_vec3 vPosition
	, Engine::_vec3 vScale)
{
	CTool_Monster01*		pInstance = new CTool_Monster01(pGraphicDev);
...
CTool_Monster01 * CTool_Monster01::CreateLoad(LPDIRECT3DDEVICE9 _pGraphicDev, wstring _tagMeshName, Engine::_vec3 * _temp_Right, Engine::_vec3 * _temp_Up, Engine::_vec3 * _temp_Look, Engine::_vec3 * _temp_Pos, Engine::_vec3 * _temp_Scale, Engine::_vec3 * _temp_Angle, int _iObjIndex)
{
	CTool_Monster01*		pInstance = new CTool_Monster01(_pGraphicDev);
...
void CTool_Monster01::Free(void)
{
