...
CTool_Boss::CTool_Boss(LPDIRECT3DDEVICE9 pGraphicDev)
	: Engine::CGameObject(pGraphicDev)
{

}

CTool_Boss::~CTool_Boss(void)
{

}

HRESULT CTool_Boss::Ready_Object(wstring _tagMeshName
								, int _iObjIndex
								...
								, Engine::_vec3 _vScale)
{
	...
	m_pTransCom->Set_Scale(0.004f, 0.004f, 0.004f);
...
HRESULT CTool_Boss::Ready_Load_Object(wstring _tagMeshName
...
Engine::_int CTool_Boss::Update_Object(const Engine::_float& fTimeDelta)
{
...
void CTool_Boss::Render_Object(void)
{
...
void CTool_Boss::SetUp_Animation(Engine::_int iIndex)
{
	m_pMeshCom->Set_AnimationSet(iIndex);
}

HRESULT CTool_Boss::Add_Component(void)
{
...
void CTool_Boss::SetUp_OnTerrain(void)
{
...
Engine::_vec3 CTool_Boss::PickUp_OnTerrain(void)
{
	Engine::CTerrainTex*		pTerrainBufferCom = dynamic_cast<Engine::CTerrainTex*>
...
CTool_Boss* CTool_Boss::Create(LPDIRECT3DDEVICE9 pGraphicDev
								, wstring _tagMeshName
								, int _iObjIndex
								, Engine::_vec3 vPosition
								, Engine::_vec3 vScale)
{
	CTool_Boss*		pInstance = new CTool_Boss(pGraphicDev);
...
CTool_Boss * CTool_Boss::CreateLoad(LPDIRECT3DDEVICE9 _pGraphicDev, wstring _tagMeshName, Engine::_vec3 * _temp_Right, Engine::_vec3 * _temp_Up, Engine::_vec3 * _temp_Look, Engine::_vec3 * _temp_Pos, Engine::_vec3 * _temp_Scale, Engine::_vec3 * _temp_Angle, int _iObjIndex)
{
	CTool_Boss*		pInstance = new CTool_Boss(_pGraphicDev);
