#ifndef Tool_Boss_h__
#define Tool_Boss_h__
...
class CTool_Boss : public Engine::CGameObject
{
private:
	explicit CTool_Boss(LPDIRECT3DDEVICE9	pGraphicDev);
public:
	virtual	~CTool_Boss(void);
...
public:
	static	CTool_Boss*		Create(LPDIRECT3DDEVICE9 pGraphicDev
		, wstring _tagMeshName
		, int iObjIndex = 0
		, Engine::_vec3 vPosition = Engine::_vec3(0.f, 0.f, 0.f)
		, Engine::_vec3 vScale = Engine::_vec3(0.01f, 0.01f, 0.01f));

	static CTool_Boss*			CreateLoad(LPDIRECT3DDEVICE9 _pGraphicDev
		, wstring _tagMeshName
		, Engine::_vec3 * _temp_Right
		, Engine::_vec3 * _temp_Up
		, Engine::_vec3 * _temp_Look
